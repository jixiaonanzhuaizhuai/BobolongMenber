...
public class AudioRecorderActivity2 extends AppCompatActivity
    ...
    private void resumeRecording() {
        ...
        if(recorder == null) {
            ...
            recorder = OmRecorder.wav(
                    new PullTransport.Default(Util.getMic(source, channel, sampleRate), AudioRecorderActivity2.this),
                    new File(filePath));
        }
    ...
    private void startPlaying(){
        try {
            ...
            visualizerView.post(new Runnable() {
                @Override
                public void run() {
                    player.setOnCompletionListener(AudioRecorderActivity2.this);
                }
            });
